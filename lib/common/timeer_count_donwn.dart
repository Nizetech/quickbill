...
class TimerCountdown extends StatefulWidget {
  ...
  const TimerCountdown({
    ...
    this.daysDescription = "d",
    this.hoursDescription = "h",
    this.minutesDescription = "m",
    this.secondsDescription = "s",
    this.spacerWidth = 10,
  });
...
class _TimerCountdownState extends State<TimerCountdown> {
  ...
  Widget _days(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          widget.enableDescriptions
              ? countdownDays + widget.daysDescription
              : countdownDays,
  ...
  Widget _hours(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          widget.enableDescriptions
              ? countdownHours + widget.hoursDescription
              : countdownHours,
          style: widget.timeTextStyle,
        ),
      ],
  ...
  Widget _minutes(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          widget.enableDescriptions
              ? countdownMinutes + widget.minutesDescription
              : countdownMinutes,
          style: widget.timeTextStyle,
        ),
      ],
  ...
  Widget _seconds(BuildContext context) {
    return Column(
      ...
      children: [
        Text(
          widget.enableDescriptions
              ? countdownSeconds + widget.secondsDescription
              : countdownSeconds,
          style: widget.timeTextStyle,
        ),
      ],

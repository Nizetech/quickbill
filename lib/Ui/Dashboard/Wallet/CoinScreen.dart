                ...
                Row(
                  ...
                  children: [
                    Container(
                        ...
                        padding: const EdgeInsets.fromLTRB(39, 20, 39, 20),
                        child: Column(
                          children: [
                            CachedNetworkImage(
                              height: 22,
                    ...
                    Container(
                      ...
                      padding: const EdgeInsets.fromLTRB(39, 8, 39, 8),
                      child: Column(
                        children: [
                          Stack(
                            children: [
                    ...
                    InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const SellCoinScreen()));
                      },
                      child: Column(
                        children: [
                          Container(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: NewStyle.tx28White.copyWith(
                                      fontSize: 12,
                                      color: list['risk'] == "low"
                                          ? const Color(0xFF72B703)
                                          : const Color(0xFFB76103),
                                      fontWeight: FontWeight.w400),
                                ),
                              ],
                            ),

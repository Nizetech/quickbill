...
class RepairstepsScreen extends StatefulWidget {
  ...
  const RepairstepsScreen({super.key, required this.repairId});
...
class _RepairstepsScreenState extends State<RepairstepsScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      total = model.repairDetails!.autoRepairHistory!.fold<num>(
        0,
        (previousValue, element) =>
            previousValue + num.parse(element.cost!.replaceAll(',', '')),
      );
      setState(() {});
    });
  }
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListView.separated(
                      ...
                      itemCount: model.repairDetails!.autoRepairHistory!.length,
                      itemBuilder: (context, index) {
                        var item =
                            model.repairDetails!.autoRepairHistory![index];
                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            SectionChip(
                              ...
                              child: buildItem(
                                ...
                                () {
                                  model.skipRepair(
                                      ...
                                      callback: () {
                                        total = model
                                            .repairDetails!.autoRepairHistory!
                                            .fold<num>(
                                          0,
                                          (previousValue, element) =>
                                              previousValue +
                                              num.parse(element.cost!
                                                  .replaceAll(',', '')),
                                        );
                                        setState(() {});
                                      });
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Text(
                          "${model.repairDetails!.autoRepairHistory!.length} Services",
                          style: MyStyle.tx16Black.copyWith(
                            color: themedata.tertiary,
                          ),
                        ),

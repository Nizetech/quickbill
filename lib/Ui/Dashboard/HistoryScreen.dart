              ...
              children: [
                TextButton(
                  style: TextButton.styleFrom(
                    ...
                    backgroundColor:
                        type == 'all' ? const Color(0xFF1B1E25) : Colors.transparent,
                ...
                TextButton(
                  style: TextButton.styleFrom(
                    padding: const EdgeInsets.fromLTRB(14, 8, 14, 8),
                    backgroundColor:
                        type == 'buy' ? const Color(0xFF1B1E25) : Colors.transparent,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(5), // Rounded corners
                    ),
                  ),
                ...
                TextButton(
                  style: TextButton.styleFrom(
                    padding: const EdgeInsets.fromLTRB(14, 8, 14, 8),
                    backgroundColor:
                        type == 'sell' ? const Color(0xFF1B1E25) : Colors.transparent,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(5), // Rounded corners
                    ),
                  ),
                ...
                InkWell(
                    onTap: () async {
                      final result = await Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => const HistoryFilterScreen()),
                      );

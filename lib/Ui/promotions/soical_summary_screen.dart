...
class SocialSummaryScreen extends StatefulWidget {
  ...
  const SocialSummaryScreen({super.key, required this.data});
                      ...
                      Row(
                        children: [
                          ...
                          Expanded(
                            flex: 3,
                            child: Text(
                              formatNumberWithOutDecimal(widget.data['qty']),
                              textAlign: TextAlign.end,
                              style: MyStyle.tx12Black.copyWith(
                                  color: themedata.tertiary,
                                  fontFamily: 'SF Pro Rounded'),
                  ...
                  child: TextButton(
                    ...
                    onPressed: () {
                      ...
                      model.buySocialBoost(
                        data,
                        ctrl: context.read<AccountProvider>(),
                      );
                    },
                    child: Text(
                      "Confirm",
